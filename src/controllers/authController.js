...
export const registerTemp = async (req, res, next) => {
	try {
		...
		var registerURL = '';
		registerURL = `${frontendHost}/final-register/${tokenRegister}`;
		if (!frontendHost) {
			registerURL = `http://localhost:${process.env.PORT}/final-register/${tokenRegister}`;
		}
...
export const forgotPassword = async (req, res, next) => {
	...
	var resetURL = '';
	resetURL = `${frontendHost}/reset-password/${resetToken}`;
	if (!frontendHost) {
		resetURL = `http://localhost:${process.env.PORT}/reset-password/${resetToken}`;
	}
